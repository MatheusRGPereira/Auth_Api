...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Veiculos authentication Api",
        Description = "API criada para exercitar o conhecimento sobre Autenticação",
        Contact = new OpenApiContact { Name = "Matheus Rodrigues", Email = "matheusgaldinoinfo@gmail.com" },
